...
if __name__=='__main__':
    ...
    test_path = '/opt/ml/processing/test/processed_data.csv'  # path to the test data
    output_evaluation_path = os.path.join('/opt/ml/processing/evaluation', 'evaluation.json')
